...
public class DashboardA extends javax.swing.JFrame {
    ...
    public DashboardA(String nombre, String tipo, String cedula) {
        this.cedula = cedula;
        this.nombre = nombre;
        this.tipo = tipo;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/emroA (1).png"))); // NOI18N
        ...
        background.add(menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 720));
        ...
        header.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-120, 0, 1170, 150));

        background.add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 0, 1040, -1));

        content.setBackground(new java.awt.Color(51, 51, 51));
        content.setLayout(new java.awt.BorderLayout());
        background.add(content, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 156, 1040, 564));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardA("PRUEBA", "ADMIN", "123456").setVisible(true);
            }
        });
    }
